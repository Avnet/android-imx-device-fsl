...
IMX_DEVICE_PATH := device/fsl/imx8m/maaxboard_mini
...
BOARD_PREBUILT_DTBOIMAGE := out/target/product/maaxboard_mini/dtbo-imx8mm.img

# imx8mm with MIPI panel display+
TARGET_BOARD_DTS_CONFIG += imx8mm:maaxboard-mini-android-mipi.dtb

TARGET_KERNEL_DEFCONFIG := maaxboard_mini_android_defconfig
